...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string, m ...echo.MiddlewareFunc) {
	...
	router.POST(baseURL+"/json", wrapper.JSONExample, m...)
	router.POST(baseURL+"/multipart", wrapper.MultipartExample, m...)
	router.POST(baseURL+"/multiple", wrapper.MultipleRequestAndResponseTypes, m...)
	router.POST(baseURL+"/reusable-responses", wrapper.ReusableResponses, m...)
	router.POST(baseURL+"/text", wrapper.TextExample, m...)
	router.POST(baseURL+"/unknown", wrapper.UnknownExample, m...)
	router.POST(baseURL+"/unspecified-content-type", wrapper.UnspecifiedContentType, m...)
	router.POST(baseURL+"/urlencoded", wrapper.URLEncodedExample, m...)
	router.POST(baseURL+"/with-headers", wrapper.HeadersExample, m...)
